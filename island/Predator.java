...
public abstract class Predator extends Animal {
    ...
    public void eat(Cell currentCell) {
        ...
        if (hp < valueHP) {
            List<Animal> currentAnimalList = currentCell.getAnimalList();
            ...
            if (!foodList.isEmpty()) {
                ...
                Animal randomFood = foodList.get(randomFoodNumber);
                ...
                if (randomProbability <= probability) {
                    ...
                    System.out.println("The " + this.getClass().getSimpleName() + " didn't eat " + classNameFood);
